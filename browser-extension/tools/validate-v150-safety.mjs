...
for (const rel of ["temporary-site-guard.js","titan-engine.js","feed-guard.js","feed-health-ui.js","popup.js"]) {
  const code = read(rel);
...
if (!process.exitCode) console.log("OK: v1.5 Adaptive Memory + Breakage Guard + Feed Guard safety invariants validated");
